...
DESCRIPTION RULES:
- Always 3-4 short lines. Never a paragraph block.
...
- Line 1 (Hook), two acceptable patterns:
  - Named-guest: [Guest Full Name] + [verb: breaks down / explains / on why] + [topic]
  - Thesis (no guest named): a punchy fragment or short declarative sentence
    stating the core idea.
- Line 2 (optional) — Elaboration: adds stakes, contrast, or a specific detail
  from the story.
- Line 3 (optional) — Show tag: "Ep [#] of [Show Name] with [Guest]" — use
  sparingly, most clips skip this.
